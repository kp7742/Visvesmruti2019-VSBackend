...
foreach ($camps as $camp) {
    if ($camp["isCampaigner"] != 1) {
        continue;
    }
    $totalunpaid += $camp["TotalFeeCollected"];
    $totalcamps++;
}
?>
<!doctype html>
...
<head>
    ...
    <title>Campaigners List | Visvesmruti - Admin Panel</title>
                    ...
                    <div class="income-dashone-pro">
                        <div class="income-rate-total">
                            <div class="price-adminpro-rate">
                                <h3><span class="counter"><?php echo $totalcamps; ?></span></h3>
                            </div>
                        </div>
                        <div class="income-range">
                            <p>Total Campaigners</p>
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <table id="table" data-toggle="table" data-pagination="false" data-search="true"
                                ...
                                <tr>
                                    ...
                                    <th data-field="regs">Registrations</th>
                                    <th data-field="comp">Computer</th>
                                    <th data-field="chemical">Chemical</th>
                                    <th data-field="civil">Civil</th>
                                    <th data-field="elec">Electrical</th>
                                    <th data-field="mech">Mechanical</th>
                                    <th data-field="schihum">Sci. & Hum.</th>
                                    <th data-field="bvoc">BVOC. Software</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                foreach ($camps as $camp) {
                                    ...
                                    foreach ($eventregs as $regs) {
                                        if ($regs["RegAdmin"] == $id) {
                                            $totalevregs++;
                                            $dept = getEventByID($regs["EVID"])[0]["EVDepartment"];
                                            if ($dept == "Computer") {
                                                $comp++;
                                            } else if ($dept == "Civil") {
                                                $civil++;
