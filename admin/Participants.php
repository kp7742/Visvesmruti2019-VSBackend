...
<head>
    ...
    <title>Participants | Visvesmruti - Admin Panel</title>
    ...
    <script type="text/javascript">const filename = "VSData-Participants"</script>
</head>
                    ...
                    <div class="income-dashone-pro">
                        <div class="income-rate-total">
                            <div class="price-adminpro-rate">
                                <h3><span class="counter"><?php echo count($participants); ?></span></h3>
                            </div>
                        </div>
                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <table id="table" data-toggle="table" data-pagination="false" data-search="true"
                                ...
                                <tr>
                                    ...
                                    <th data-field="events">Events Count</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
