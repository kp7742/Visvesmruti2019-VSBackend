...
if (isset($_GET["Computer"])) {
    $department = "Computer";
} else if (isset($_GET["Chemical"])) {
    $department = "Chemical";
} else if (isset($_GET["Civil"])) {
    $department = "Civil";
} else if (isset($_GET["Electrical"])) {
    $department = "Electrical";
} else if (isset($_GET["Mechanical"])) {
    $department = "Mechanical";
} else if (isset($_GET["SciHum"])) {
    $department = "Science and Humanities";
} else if (isset($_GET["BVOC"])) {
    $department = "BVOC. Software";
}
...
foreach ($events as $event) {
    if ($department != "All" && $department != $event["EVDepartment"]) {
        continue;
    }
...
<head>
    ...
    <title>Dashboard | VS Admin Panel</title>
                    ...
                    <ul class="nav navbar-nav mai-top-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div role="menu" class="dropdown-menu animated flipInX">
                                ...
                                <?php
                                if ($email == "visvesmruti.rngpit@gmail.com") {
                                    echo '<a href="Campaigners.php" class="dropdown-item">Campaigners List</a>
                                <a href="Coordinators.php" class="dropdown-item">Coordinators List</a>
                                <a href="EventRegs.php" class="dropdown-item">Event Registrations List</a>';
                                }
                                ?>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                               class="nav-link dropdown-toggle">Departments <span class="angle-down-topmenu"><i
                                            class="fa fa-angle-down"></i></span></a>
                            <div role="menu" class="dropdown-menu animated flipInX">
                                <a href="DashboardAdmins.php" class="dropdown-item">All</a>
                                <a href="DashboardAdmins.php?Computer" class="dropdown-item">Computer</a>
                                <a href="DashboardAdmins.php?Chemical" class="dropdown-item">Chemical</a>
                                <a href="DashboardAdmins.php?Civil" class="dropdown-item">Civil</a>
                                <a href="DashboardAdmins.php?Electrical" class="dropdown-item">Electrical</a>
                                <a href="DashboardAdmins.php?Mechanical" class="dropdown-item">Mechanical</a>
                                <a href="DashboardAdmins.php?SciHum" class="dropdown-item">Sci. & Hum.</a>
                                <a href="DashboardAdmins.php?BVOC" class="dropdown-item">BVOC Software</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                               class="nav-link dropdown-toggle">Events
                                <span class="angle-down-topmenu"><i class="fa fa-angle-down"></i></span>
                            </a>
                            <div role="menu" class="dropdown-menu animated flipInX">
                                <a href="<?php echo "DashboardAdmins.php?" . $department; ?>"
                                   class="dropdown-item">All</a>
                                <?php
                                foreach ($eventlist as $event) {
                                    echo '<a href="DashboardAdmins.php?' . $department . '&evid=' . $event["EVID"] . '" class="dropdown-item">' . $event["EVName"] . '</a>';
                                }
                                ?>
                            </div>
                        </li>
                    ...
                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                        <li class="nav-item">
                            ...
                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                <li><a href="DashboardAdmins.php?Logout">Log Out</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
